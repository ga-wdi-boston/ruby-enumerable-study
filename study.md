...
```md
In Arrays, length simply means the size of the array.
In Enumerables though, there is no way to know what kind of structure it's
operating on, and hence has no way to calculate the size of the enumerable.
```
